<?php
// BARIS PERTAMA MUTLAK
session_start(); 

// 1. Definisikan variabel sesi dan login SEBELUM kode lainnya
$isLoggedIn = isset($_SESSION['user_id']) && !empty($_SESSION['user_id']);
$userName = $isLoggedIn ? htmlspecialchars($_SESSION['nama']) : 'User Name'; 

// 2. Hubungkan ke Database
include 'assets/php/config.php'; 

// 3. Logika website lainnya
// Ambil semua data produk
$sql = "SELECT * FROM produk ORDER BY idpro ASC";
...
<!DOCTYPE html>
   ...
   <div class="cart-footer">
      <div class="cart-total">
         <span>Total:</span>
         <span id="cart-total-price">Rp0</span>
      </div>
      <button id="checkout-btn" class="button">Checkout</button>
      <button id="reset-btn" class="button button-dark">Reset</button>
   </div>
   </div>
   ...
   <body>
         ...
         <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
               <ul class="nav__list">
                  ...
                  <?php 
                  // Pastikan tidak ada <li> di antara CONTACT dan <?php
                  if ($isLoggedIn) {
                     // Ini menghasilkan <li>...LOGOUT...</li>
                     echo '<li>';
                     echo '<a href="assets/php/logout.php" class="nav__link" id="auth-link">LOGOUT</a>';
                     echo '</li>';
                  } else {
                     // Ini menghasilkan <li>...LOGIN...</li>
                     echo '<li>';
                     echo '<a href="assets/php/login.php" class="nav__link" id="auth-link">LOGIN</a>';
                     echo '</li>';
                  } ?>
            ...
            <a href="assets/php/profile.php" class="nav__profile-container" 
               id="nav-profile-container" 
               style="display: <?= $isLoggedIn ? 'flex' : 'none'; ?>;">
               
               <i class="ri-user-fill profile__icon" id="profile-icon"></i>
               
               <span class="profile__username" id="profile-username"><?= $userName ?></span>
            </a>
                  ...
                  <div class="swiper-wrapper">
                     <article class="popular__card swiper-slide">
                        <div class="popular__images">
                           ...
                           <img src="assets/img/popular-coffee-1.png" alt="" class="popular__coffee">
                        </div>
    ...
    <div class="products__container container grid">
        <?php while ($product = mysqli_fetch_assoc($row)) { ?>
        <article class="products__card" 
        data-id="<?= $product['idpro'] ?>"
         data-name="<?= htmlspecialchars($product['nama'], ENT_QUOTES, 'UTF-8') ?>"
         data-price="Rp <?= number_format($product['harga'], 0, ',', '.') ?>"
         data-img="<?= htmlspecialchars($product['image'], ENT_QUOTES, 'UTF-8') ?>">
